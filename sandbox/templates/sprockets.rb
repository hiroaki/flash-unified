# Rails application template for sprockets-based sandbox wiring
# Docs: https://guides.rubyonrails.org/rails_application_templates.html
# Assumes Rails app created with `--asset-pipeline=sprockets` and without Importmap.
...
after_bundle do
  ...
  say "Sandbox wiring for flash_unified (sprockets) completed.", :green
end
