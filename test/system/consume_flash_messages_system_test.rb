...
class ConsumeFlashMessagesSystemTest < ApplicationSystemTestCase
  test "consumeFlashMessages removes storages by default" do
    visit "/flash/render_consume"
  ...
  test "renderFlashMessages renders messages and removes storages" do
    visit "/flash/render_consume"
  ...
  test "consumeFlashMessages with keep=true preserves storages" do
    visit "/flash/render_consume"
